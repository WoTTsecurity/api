...
class DeviceDetailViewTests(TestCase):
    ...
    def test_get_device_detail_software(self, mock_timezone):
        ...
        response = self.client.get(self.url2)
        self.assertInHTML(
            '<td class="pl-4" id="eol_info"><span class="p-1 text-danger"><i class="fas fa-exclamation-circle" >'
    ...
    def test_weekly_ra(self):
        ...
        RecommendedActionStatus.objects.bulk_create([
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[0].__name__, action_param=None),
            ...
            # both devices affected - counts as one RA
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[1].__name__, action_param=None),
                device=self.device0, status=RecommendedAction.Status.AFFECTED),
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[1].__name__, action_param=None),
                device=self.device1, status=RecommendedAction.Status.AFFECTED),
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[2].__name__, action_param=None),
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[3].__name__, action_param=None),
                device=self.device0, status=RecommendedAction.Status.NOT_AFFECTED,
                resolved_at=today),
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[3].__name__, action_param=None),
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[4].__name__, action_param=None),
                device=self.device0, status=RecommendedAction.Status.NOT_AFFECTED,
                resolved_at=today),
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[4].__name__, action_param=None),
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[5].__name__, action_param=None),
                device=self.device0, status=RecommendedAction.Status.NOT_AFFECTED),
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[5].__name__, action_param=None),
                device=self.device1, status=RecommendedAction.Status.NOT_AFFECTED,
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[6].__name__, action_param=None),
                device=self.device1,
                status=RecommendedAction.Status.NOT_AFFECTED,
            ...
            RecommendedActionStatus(
                ra=RecommendedAction.objects.get(action_class=self.test_actions[7].__name__, action_param=None),
                device=self.device1,
